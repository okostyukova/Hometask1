...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="f377c519-43af-43a4-b8a0-7f49753a8269" name="Default" comment="" />
  ...
  <component name="FileEditorManager">
    <leaf SIDE_TABS_SIZE_LIMIT_KEY="300">
      ...
      <file leaf-file-name="MainActivity.java" pinned="false" current-in-tab="true">
        <entry file="file://$PROJECT_DIR$/app/src/main/java/com/example/olgak/manyathenetwork/MainActivity.java">
          <provider selected="true" editor-type-id="text-editor">
